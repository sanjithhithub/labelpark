      ...
      >
        ...
        >
          ...
          >
            {NAV.map((l) => (
              <li key={l.to}>
                <DeskLink to={l.to} active={pathname === l.to}>
                  {l.label}
                </DeskLink>
              </li>
            ))}
            ...
            <li ref={dropRef} style={{ position: "relative" }}>
              ...
              >
                ...
                >
                  <path
                    d="M1 1L5 5L9 1"
                    stroke={isProduct || dropOpen ? "#1b9e2d" : "#888"}
                    strokeWidth="1.8"
                    strokeLinecap="round"
                ...
                <span
                  style={{
                    ...
                    background: "#1b9e2d",
                    borderRadius: 2,
                    transform: isProduct ? "scaleX(1)" : "scaleX(0)",
                  ...
                  {PRODUCTS.map((pl) => (
                    <Link
                      ...
                      style={{
                        ...
                        background:
                          pathname === pl.to ? "#f0fdf2" : "transparent",
                        transition: "background .15s,color .15s",
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = "#f0fdf2";
                        e.currentTarget.style.color = "#1b9e2d";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background =
                          pathname === pl.to ? "#f0fdf2" : "transparent";
                        e.currentTarget.style.color =
                          pathname === pl.to ? "#1b9e2d" : "#333";
                      }}
                    >
                      {pl.label}
                    </Link>
        ...
        {mobileOpen && (
          <div
            style={{
              ...
              padding: "14px var(--pad-x,20px) 22px",
            ...
            {[...NAV, ...PRODUCTS].map((l) => (
              <Link
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: 15,
                  color: pathname === l.to ? "#1b9e2d" : "#222",
